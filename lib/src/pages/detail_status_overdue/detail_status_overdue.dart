...
class DetailStatusOverduePage extends StatefulWidget {
  final HistoryModel status;

  const DetailStatusOverduePage({Key? key, required this.status}) : super(key: key);

  @override
  State<DetailStatusOverduePage> createState() => _DetailStatusOverduePageState();
}

class _DetailStatusOverduePageState extends State<DetailStatusOverduePage> {
